    ...
    <div>
        ...
        <div class="footer">
            <div class="section">
                ...
                <div class="foot-box">
                    <div class="copyright">
                        <p>版权所有 用vue做的一个电商网站 </p>
                        <p>公司地址： 联系电话：</p>
                        <p class="gray">Copyright © 2018-2018 Junwu Corporation,All Rights Reserved.</p>
                    </div>
                    <div class="service">
    ...
    export default {
        ...
        created() {
            this.$axios.get('site/account/islogin').then(res => {
                if (res.data.code === 'logined') this.$store.commit('toggleLoginStatus', true)
            })
        },
        methods: {
            logout() {
