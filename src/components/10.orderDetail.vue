                            ...
                            <div class="right-auto">
                                <div class="bg-wrap" style="min-height: 765px;">
                                    <div class="sub-tit" style="padding-top: unset;">
                                        <a @click="$router.go(-1)" class="add"><i class="iconfont icon-reply"></i>返回</a>
                                        <ul>
                                            <li class="selected">
                                    ...
                                    <div class="order-progress">
                                        <ul>
                                            <li :class="{'active': orderinfo.status>=1}" class="first">
                                                ...
                                                <div class="info">{{orderinfo.confirm_time | dateFormat("YYYY-MM-DD h:mm:ss")}}</div>
                                            </li>
                                            <li :class="{'active': orderinfo.status>=2}" class="">
                                                <div class="progress">已付款</div>
                                                <div class="info">{{orderinfo.payment_time | dateFormat("YYYY-MM-DD h:mm:ss")}}</div>
                                            </li>
                                            <li :class="{'active': orderinfo.status>=3}" class="">
                                                <div class="progress">已经发货</div>
                                                <div class="info">{{orderinfo.express_time | dateFormat("YYYY-MM-DD h:mm:ss")}}</div>
                                            </li>
                                            <li :class="{'active': orderinfo.status>=4}" class="last">
                                                <div class="progress">已完成</div>
                                                <div class="info">{{orderinfo.complete_time | dateFormat("YYYY-MM-DD h:mm:ss")}}</div>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="form-box accept-box form-box1">
                                        <dl class="head form-group">
                                            <dd>
                                                ...
                                                <router-link :to="'/orderPay/' + orderinfo.id" class="btn-pay" v-if="orderinfo.status===1">去付款</router-link>
                                                <!---->
                                            </dd>
                                        </dl>
                                        <dl class="form-group">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="7" align="right">
                                                        ...
                                                        <p style="font-size: 22px;">{{orderinfo.status===1 ? '应付' : '已付'}}总金额：
                                                            <b class="red">￥{{orderinfo.payable_amount}}</b>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
...
<script>
    export default {
        ...
        created() {
            this.$axios.get('site/validate/order/getorderdetial/' + this.$route.params.orderid).then(res => {
